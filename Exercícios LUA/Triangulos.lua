...
--]]
print("Digite o primeiro lado do triangulo: ")
lado1 = tonumber(io.read())
print("Digite o segundo lado do triangulo: ")
lado2 = tonumber(io.read())
print("Digite o terceiro lado do triangulo: ")
...
if(lado1 + lado2 > lado3) and (lado1 + lado3 > lado2) and (lado2 + lado3 > lado1) then 
    ...
    elseif (lado1 == lado2) and (lado1 == lado3) or (lado2 == lado3) then
